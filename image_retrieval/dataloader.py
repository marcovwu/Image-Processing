...
def touch_find_whole_image_name(protopath,num):
    ...
    for i in range(1,num):
        p_string=(protopath,'/',str(1),' (',str(i),').',filename[0].split('.')[-1])
...
class datasets(Dataset):
    ...
    def __init__(self,proto_path,data_path,proto_transform=None,data_transform=None):     
        super().__init__()
        self.proto_list = touch_find_whole_image_name(proto_path,366)
        self.data_list = touch_find_whole_image_name(data_path,366)        
